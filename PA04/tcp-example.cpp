...
main (int argc, char *argv[])
{
  ...
  devices1 = pointToPoint.Install (n0n1);
...
Ipv4AddressHelper address2;
  ...
  Ptr<OutputStreamWrapper> stream = asciiTraceHelper.CreateFileStream ("Q3_tcp-example.cwnd");
  ns3TcpSocket->TraceConnectWithoutContext ("CongestionWindow", MakeBoundCallback (&CwndChange, stream));


  //detailed trace of queue enq/deq packet tx/rx
  AsciiTraceHelper ascii;
  pointToPoint.EnableAsciiAll (ascii.CreateFileStream ("Q3_tcp-example.tr"));
  pointToPoint.EnablePcapAll ("Q3_tcp-example");
